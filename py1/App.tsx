      ...
      <footer className="h-20 shrink-0 border-t border-gray-800 bg-[#0f172a] flex items-center justify-between px-6 z-50 relative shadow-[0_-5px_20px_rgba(0,0,0,0.3)]">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex items-center gap-3 pr-4 md:border-r border-gray-700">
            ...
            <a href="https://t.me/NexoraAICompany" className="text-gray-500 hover:text-blue-400 transition-colors"><Send size={20} /></a>
            <a href="https://nexoraaistudio.tech" className="text-gray-500 hover:text-nexora-500 transition-colors"><Globe size={20} /></a>
          </div>
