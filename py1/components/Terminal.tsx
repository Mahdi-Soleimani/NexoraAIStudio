...
export const Terminal: React.FC<TerminalProps> = ({ logs, isOpen, onToggle, onClear }) => {
  ...
  // Don't render anything if terminal is closed
  ...
  return (
    ...
    >
      ...
      {/* Terminal Header */}
      <div
        className="flex items-center justify-between px-4 h-10 shrink-0 bg-[#0c0c0c] border-b border-gray-800 select-none"
      >
