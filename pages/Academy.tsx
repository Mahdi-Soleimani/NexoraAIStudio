...
const n8nBootcampVideos = [
  ...
  {
    id: 2,
    title: "جلسه ۱: آموزش ساختار داده ها در n8n با پایتون برای اتوماسیون حرفه‌ای",
    hash: "pkaop44", // هش ویدیو از لینک آپارات
    duration: "30:07",
    level: "BootCamp",
    description: "قبل اینکه وارد دنیای n۸n بشیم باید با یه سری از مباحث پیشنیاز پایه آشنا شویم و بعد به سراغ آغاز n۸n و ساخت agentهای هوشمند برویم. در این جلسه به زبان مشترک داده در n۸n میپردازیم، ساختار داده‌ها که برای فهم آسان آن با پایتون براتون اون رو شرح دادم."
  },
