        ...
        {[
          {
            ...
            type: "تمام وقت",
            location: "ریموت",
            description: "ما به دنبال یک توسعه‌دهنده n8n با تجربه هستیم که بتواند گردش‌های کاری پیچیده اتوماسیون را طراحی و پیاده‌سازی کند. شما مسئول ایجاد و بهینه‌سازی فرآیندهای خودکار هوشمند خواهید بود که به بهبود کارایی تیم و کسب‌وکار کمک می‌کند. تسلط به n8n، API ها، و یکپارچه‌سازی سیستم‌های مختلف الزامی است."
          },
          {
