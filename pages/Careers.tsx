        ...
        {[
          {
            ...
            type: "تمام وقت",
            location: "ریموت",
            description: `شرح شغلی

ما به یک توسعه‌دهنده مسلط به n8n نیاز داریم که بتواند سیستم‌های مختلف را از طریق APIها و اتوماسیون‌های هوشمند به یکدیگر متصل کند و گردش‌کارهای پیچیده را طراحی و اجرا کند.
این نقش برای پروژه‌های اتوماسیون صنعتی و سازمانی بسیار کلیدی است.

مسئولیت‌ها

- طراحی، توسعه و مدیریت Workflowهای پیشرفته در n8n
- اتصال سیستم‌ها از طریق API، Webhook و دیتابیس
- تحلیل فرآیندهای فعلی و تبدیل آن‌ها به اتوماسیون
- رفع باگ‌ها، بهینه‌سازی و مستندسازی گردش‌کارها
- همکاری با تیم AI برای یکپارچگی ایجنت‌ها با اتوماسیون

مهارت‌های لازم

- تسلط کامل به n8n (Nodeها، ترگرها، شرط‌ها، فانکشن‌ها)
- آشنایی با REST API، JSON، Webhook
- توانایی طراحی سیستم‌های اتوماسیون
- آشنایی با JavaScript یک مزیت محسوب می‌شود
- تجربه کار با پایگاه داده‌ها (MongoDB / MySQL)`
          },
          {
